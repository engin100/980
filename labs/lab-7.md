...
- **October 27th, 2023, 5pm**: Final PCB design submission deadline.
...
7. Look at the Projects Tab on the left side of the screen. Right click your project name in bold and click Add New to Project → Schematic. A blank piece of paper should appear on the screen. This is where you are to lay out your schematic drawing. A few instructions for laying out a schematic:
    ...
    * The ’Components: Final PCBs’ spreadsheet on Canvas under Files / Labs / Lab 6 Altium Resources lists all components you might need for your system, their schematic names, and footprint names. It’s important to note: all 1 kOhm resistors must use a 1206 resistor footprint.
